        ...
        <div className="flex w-[60%] flex-col gap-5 rounded-lg border bg-[#00BCD147] p-5 max-sm:w-[95%]">
          ...
          >
            ...
            <Image
              ...
              width={300}
              height={500}
              className={`absolute top-[30%] right-[55%] border rounded-lg ${hoveredEventra && "right-[60%]"} transform-all shadow-2xl duration-800`}
            />
            <Image
          ...
          <Button className="z-1 w-fit cursor-pointer bg-black transition-colors duration-300 ease-in-out hover:bg-gradient-to-r hover:from-[#A632F2] hover:to-[#FBA325]" onClick={() => navigate.push("/case-studies/eventra")}>
            Case Study
            <Image src={logo} alt="logo" width={20} height={20} />
          </Button>
        </div>
