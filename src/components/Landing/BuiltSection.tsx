...
export default function BuiltSection() {
  ...
  return (
    <section className="flex flex-col items-center gap-5 py-20">
      ...
      <Button className="group relative overflow-hidden rounded-md bg-gradient-to-r from-[#A632F2] to-[#FBA325] cursor-pointer px-4 py-2 text-base text-white" onClick={() => router.push("/process")}>
