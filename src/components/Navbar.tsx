...
export default function Navbar() {
  return (
    <nav className="flex px-10 p-5 items-center justify-between ">
      ...
      <button className="bg-white p-2 px-4 rounded-2xl h-fit text-black font-medium ">Contact us</button> 
    </nav>
  );
}
